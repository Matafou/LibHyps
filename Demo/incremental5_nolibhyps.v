...
Proof.
  intros * h_EE_e_v_. 
  revert v'.
  induction h_EE_e_v_ as
      [v | x v h_MapsTo_x_v_Γ_ | e1 e2 v1 v2 op f h_e_v1 h_all_EQ_v1_v'_ h_e_v2 h_all_EQ_v2_v'_ hop
       | x e v h_EE_e_v_ h_all_EQ_v_v'_ ]
  ; [intros v' h_EE_v_v'_ h_EQ_Γ_Γ'_ | intros v' h_EE_x_v'_ h_EQ_Γ_Γ'_
     | intros v' h_EE_op_e1_e2_v'_ h_EQ_Γ_Γ'_| intros v' h_EE_Assign_x_e_v'_ h_EQ_Γ_Γ'_ ].
  - inversion h_EE_v_v'_ .
    red;auto.
  - inversion h_EE_x_v'_; auto; subst.
    rewrite h_EQ_Γ_Γ'_ in h_MapsTo_x_v_Γ_.
    red.
    assert (v=v0);subst.
    { eapply EnvFact.MapsTo_fun;eauto. }
    auto.
  - inversion h_EE_op_e1_e2_v'_ as [| |e0 e3 v0 v3 op0 f0 h_EE_e1_v0_ h_EE_e2_v3_ | ];subst.
    ...
    destruct h_all_EQ_v1_v'_ as [h_eq_val_v1_val_v0_ ?], h_all_EQ_v2_v'_ as [h_eq_val_v2_val_v3_ ?].
    rewrite h_eq_val_v1_val_v0_, h_eq_val_v2_val_v3_.
    red;auto.
  - inversion h_EE_Assign_x_e_v'_ as [ | | | x0 e0 v0 h_EE_e_v0_ ]; subst.
